...
NNCPE_x = _tfGraphDefProducer_x.clone(
    ...
    FileName = "/uscms_data/d3/ssekhar/CMSSW_12_6_2/src/graph_x_1dcnn_p1_2024_by25k_irrad_BPIXL1_121422.pb"
)
...
NNCPE_y = _tfGraphDefProducer_y.clone(
    ...
    FileName = "/uscms_data/d3/ssekhar/CMSSW_12_6_2/src/graph_y_1dcnn_p1_2024_by25k_irrad_BPIXL1_121422.pb"
)
